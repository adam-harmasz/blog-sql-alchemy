...
stmt = select(User.__table__).where(
    User.__table__.c.name == "David"
)  # tutaj wykorzystujemy obiekt Table i atrybut c dzięki któremu możemy dostać się do kolumn
# print("###")
# print(stmt)
...
stmt = select(User).where(
    User.name == "David"
)  # Tu możemy bezpośrednio dostać się do kolumn
